...
{
    /// <summary>
    /// Contains definition for creating a random data element value.
    /// </summary>
    public class RandomDataElementDataRequest
    {
        ...
        private bool _useUnitedStatesTemplate = false;
        private bool _useCanadaTemplate = false;
        private bool _useMexicoTemplate = false;
        private bool _outputPersonName = false;
        private bool _outputFullName = false;
        private bool _outputMiddleInitial = false;
        private bool _outputLastName = false;
        private bool _outputFirstName = false;
        private bool _outputBusinessName = false;
        private bool _outputTelephoneNumber = false;
        private bool _outputEmailAddress = false;
        private bool _outputGUID = false;
        ...
        /// Default constructor.
        /// </summary>
        public RandomDataElementDataRequest()
        {
            ;
        }
        ...
        /// <summary>
        /// UseUnitedStatesTemplate Property.
        /// </summary>
        public bool UseUnitedStatesTemplate
        {
            get
            {
                return _useUnitedStatesTemplate;
            }
            set
            {
                _useUnitedStatesTemplate = value;
            }
        }

        /// <summary>
        /// UseCanadaTemplate Property.
        /// </summary>
        public bool UseCanadaTemplate
        {
            get
            {
                return _useCanadaTemplate;
            }
            set
            {
                _useCanadaTemplate = value;
            }
        }

        /// <summary>
        /// UseMexicoTemplate Property.
        /// </summary>
        public bool UseMexicoTemplate
        {
            get
            {
                return _useMexicoTemplate;
            }
            set
            {
                _useMexicoTemplate = value;
            }
        }

        /// <summary>
        /// OutputPersonName Property.
        /// </summary>
        public bool OutputPersonName
        {
            get
            {
                return _outputPersonName;
            }
            set
            {
                _outputPersonName = value;
            }
        }

        /// <summary>
        /// OutputFullName Property.
        /// </summary>
        public bool OutputFullName
        {
            get
            {
        ...
        /// <summary>
        /// OutputMiddleInitial Property.
        /// </summary>
        public bool OutputMiddleInitial
        {
            get
            {
                return _outputMiddleInitial;
            }
            set
            {
                _outputMiddleInitial = value;
            }
        }

        /// <summary>
        /// OutputLastName Property.
        /// </summary>
        public bool OutputLastName
        {
            get
            {
                return _outputLastName;
            }
            set
            {
                _outputLastName = value;
            }
        }

        /// <summary>
        /// OutputFirstName Property.
        /// </summary>
        public bool OutputFirstName
        {
            get
            {
                return _outputFirstName;
            }
            set
            {
                _outputFirstName = value;
            }
        }

        /// <summary>
        /// OutputBusinessName Property.
        /// </summary>
        public bool OutputBusinessName
        {
            get
            {
                return _outputBusinessName;
            }
            set
            {
                _outputBusinessName = value;
            }
        }

        /// <summary>
        /// OutputTelephoneNumber Property.
        /// </summary>
        public bool OutputTelephoneNumber
        {
            get
            {
                return _outputTelephoneNumber;
            }
            set
            {
                _outputTelephoneNumber = value;
            }
        }

        /// <summary>
        /// OutputEmailAddress Property.
        /// </summary>
        public bool OutputEmailAddress
        {
            get
            {
                return _outputEmailAddress;
            }
            set
            {
                _outputEmailAddress = value;
            }
        }
        ...
        {
            XmlSerializer ser = new XmlSerializer(typeof(RandomDataElementDataRequest));
        ...
        /// <returns>An instance of RandomDataElementDataRequest.</returns>
        public static RandomDataElementDataRequest LoadFromXmlFile(string filePath)
        {
            XmlSerializer deserializer = new XmlSerializer(typeof(RandomDataElementDataRequest));
            TextReader textReader = new StreamReader(filePath);
            RandomDataElementDataRequest columnDefinitions;
            columnDefinitions = (RandomDataElementDataRequest)deserializer.Deserialize(textReader);
            textReader.Close();
