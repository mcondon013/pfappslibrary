...
{
    /// <summary>
    /// Contains definition for a random boolean value.
    /// </summary>
    public class RandomBooleanDataRequest
    {
        ...
        private double _percentOutputValuesAsTrue = 50.0;
        private double _percentOutputValuesAsFalse = 50.0;
        private bool _booleanOutput = true;
        private bool _numericOutput = false;
        private string _numericTrueValue = "1";
        private string _numericFalseValue = "0";
        ...
        private bool _stringOutput = false;
        private string _stringTrueValue = "50";
        private string _stringFalseValue = "50";
        ...
        /// Default constructor.
        /// </summary>
        public RandomBooleanDataRequest()
        {
            ;
        }
        ...
        /// <summary>
        /// PercentOutputValuesAsTrue Property.
        /// </summary>
        public double PercentOutputValuesAsTrue
        {
            get
            {
                return _percentOutputValuesAsTrue;
            }
            set
            {
                _percentOutputValuesAsTrue = value;
            }
        }

        /// <summary>
        /// PercentOutputValuesAsFalse Property.
        /// </summary>
        public double PercentOutputValuesAsFalse
        {
            get
            {
                return _percentOutputValuesAsFalse;
            }
            set
            {
                _percentOutputValuesAsFalse = value;
            }
        }

        /// <summary>
        /// BooleanOutput Property.
        /// </summary>
        public bool BooleanOutput
        {
            get
            {
                return _booleanOutput;
            }
            set
            {
                _booleanOutput = value;
            }
        }

        /// <summary>
        /// NumericOutput Property.
        /// </summary>
        public bool NumericOutput
        {
            ...
            set
            {
                _numericOutput = value;
            }
        }

        /// <summary>
        /// NumericTrueValue Property.
        /// </summary>
        public string NumericTrueValue
        {
            get
            {
                return _numericTrueValue;
            }
            set
            {
                _numericTrueValue = value;
            }
        }

        /// <summary>
        /// NumericFalseValue Property.
        /// </summary>
        public string NumericFalseValue
        {
            get
            {
                return _numericFalseValue;
            }
            set
            {
                _numericFalseValue = value;
            }
        }
        ...
        /// <summary>
        /// StringTrueValue Property.
        /// </summary>
        public string StringTrueValue
        {
            get
            {
                return _stringTrueValue;
            }
            set
            {
                _stringTrueValue = value;
            }
        }

        /// <summary>
        /// StringFalseValue Property.
        /// </summary>
        public string StringFalseValue
        {
            get
            {
                return _stringFalseValue;
            }
            set
            {
                _stringFalseValue = value;
            }
        }
        ...
        {
            XmlSerializer ser = new XmlSerializer(typeof(RandomBooleanDataRequest));
        ...
        /// <returns>An instance of BooleanRandomDataRequest.</returns>
        public static RandomBooleanDataRequest LoadFromXmlFile(string filePath)
        {
            XmlSerializer deserializer = new XmlSerializer(typeof(RandomBooleanDataRequest));
            TextReader textReader = new StreamReader(filePath);
            RandomBooleanDataRequest columnDefinitions;
            columnDefinitions = (RandomBooleanDataRequest)deserializer.Deserialize(textReader);
            textReader.Close();
