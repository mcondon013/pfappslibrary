...
{
    /// <summary>
    /// Contains definition for a random bytes value.
    /// </summary>
    public class RandomBytesDataRequest
    {
        ...
        private bool _outputByte = false;
        private bool _outputChar = false;
        private bool _outputArrayOfValues = false;
        private string _minArrayLength = string.Empty;
        private string _maxArrayLength = string.Empty;
        private bool _outputSingleValue = false;
        ...
        /// <summary>
        /// OutputArrayOfValues Property.
        /// </summary>
        public bool OutputArrayOfValues
        {
            get
            {
                return _outputArrayOfValues;
            }
            set
            {
                _outputArrayOfValues = value;
            }
        }

        /// <summary>
        /// MinArrayLength Property.
        /// </summary>
        public string MinArrayLength
        {
            get
            {
                return _minArrayLength;
            }
            set
            {
                _minArrayLength = value;
            }
        }
        ...
        /// <summary>
        /// OutputSingleValue Property.
        /// </summary>
        public bool OutputSingleValue
        {
            get
            {
                return _outputSingleValue;
            }
            set
            {
                _outputSingleValue = value;
            }
        }
        ...
        {
            XmlSerializer ser = new XmlSerializer(typeof(RandomBytesDataRequest));
        ...
        /// <returns>An instance of RandomBytesDataRequest.</returns>
        public static RandomBytesDataRequest LoadFromXmlFile(string filePath)
        {
            XmlSerializer deserializer = new XmlSerializer(typeof(RandomBytesDataRequest));
            TextReader textReader = new StreamReader(filePath);
            RandomBytesDataRequest columnDefinitions;
            columnDefinitions = (RandomBytesDataRequest)deserializer.Deserialize(textReader);
            textReader.Close();
