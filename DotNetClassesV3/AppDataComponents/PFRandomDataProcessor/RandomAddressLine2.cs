...
{
    /// <summary>
    /// Random data class for storing address line 2 value.
    /// </summary>
    public class RandomAddressLine2
    {
        ...
        {
            XmlSerializer ser = new XmlSerializer(typeof(RandomAddressLine1));
        ...
        /// <returns>An instance of RandomAddressLine1.</returns>
        public static RandomAddressLine1 LoadFromXmlFile(string filePath)
        {
            XmlSerializer deserializer = new XmlSerializer(typeof(RandomAddressLine1));
            TextReader textReader = new StreamReader(filePath);
            RandomAddressLine1 objectInstance;
            objectInstance = (RandomAddressLine1)deserializer.Deserialize(textReader);
            textReader.Close();
        ...
        /// <returns>An instance of RandomAddressLine1.</returns>
        public static RandomAddressLine1 LoadFromXmlString(string xmlString)
        {
            XmlSerializer deserializer = new XmlSerializer(typeof(RandomAddressLine1));
            StringReader strReader = new StringReader(xmlString);
            RandomAddressLine1 objectInstance;
            objectInstance = (RandomAddressLine1)deserializer.Deserialize(strReader);
            strReader.Close();
            return objectInstance;
        }
