...
{
    /// <summary>
    /// Class contains random birth date for a random person name.
    /// </summary>
    public class RandomPersonDemographics
    {
        ...
        /// Constructor.
        /// </summary>
        public RandomPersonDemographics()
        {
            ;
        }
        ...
        {
            XmlSerializer ser = new XmlSerializer(typeof(RandomPersonDemographics));
        ...
        public static RandomPersonDemographics LoadFromXmlFile(string filePath)
        {
            XmlSerializer deserializer = new XmlSerializer(typeof(RandomPersonDemographics));
            TextReader textReader = new StreamReader(filePath);
            RandomPersonDemographics objectInstance;
            objectInstance = (RandomPersonDemographics)deserializer.Deserialize(textReader);
            textReader.Close();
        ...
        /// <returns>An instance of RandomName.</returns>
        public static RandomPersonDemographics LoadFromXmlString(string xmlString)
        {
            XmlSerializer deserializer = new XmlSerializer(typeof(RandomPersonDemographics));
            StringReader strReader = new StringReader(xmlString);
            RandomPersonDemographics objectInstance;
            objectInstance = (RandomPersonDemographics)deserializer.Deserialize(strReader);
            strReader.Close();
            return objectInstance;
        }
