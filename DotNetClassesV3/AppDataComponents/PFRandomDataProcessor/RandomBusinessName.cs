...
{
    /// <summary>
    /// Contains randomized business names.
    /// </summary>
    public class RandomBusinessName
    {
        ...
        private enNameLanguage _language = enNameLanguage.NotSpecified;
        ...
        /// Language property.
        /// </summary>
        public enNameLanguage Language
        {
            get
            {
                return _language;
        ...
        {
            XmlSerializer ser = new XmlSerializer(typeof(RandomBusinessName));
        ...
        /// <returns>An instance of RandomBusinessName.</returns>
        public static RandomBusinessName LoadFromXmlFile(string filePath)
        {
            XmlSerializer deserializer = new XmlSerializer(typeof(RandomBusinessName));
            TextReader textReader = new StreamReader(filePath);
            RandomBusinessName objectInstance;
            objectInstance = (RandomBusinessName)deserializer.Deserialize(textReader);
            textReader.Close();
        ...
        /// <returns>An instance of RandomBusinessName.</returns>
        public static RandomBusinessName LoadFromXmlString(string xmlString)
        {
            XmlSerializer deserializer = new XmlSerializer(typeof(RandomBusinessName));
            StringReader strReader = new StringReader(xmlString);
            RandomBusinessName objectInstance;
            objectInstance = (RandomBusinessName)deserializer.Deserialize(strReader);
            strReader.Close();
            return objectInstance;
        }
