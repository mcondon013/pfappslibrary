...
{
    /// <summary>
    /// Class contains all the parts of a random name plus a random gender value.
    /// </summary>
    public class RandomPersonName
    {
        ...
        {
            XmlSerializer ser = new XmlSerializer(typeof(RandomPersonName));
        ...
        public static RandomPersonName LoadFromXmlFile(string filePath)
        {
            XmlSerializer deserializer = new XmlSerializer(typeof(RandomPersonName));
            TextReader textReader = new StreamReader(filePath);
            RandomPersonName columnDefinitions;
            columnDefinitions = (RandomPersonName)deserializer.Deserialize(textReader);
            textReader.Close();
