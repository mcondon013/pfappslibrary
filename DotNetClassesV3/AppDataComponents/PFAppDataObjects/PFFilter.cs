...
{
    /// <summary>
    /// Contains an ADO.NET Filter definition.
    /// </summary>
    public class PFFilter
    {
        ...
        private PFList<PFFilterDef> _filterDefs = new PFList<PFFilterDef>();
        ...
        {
            XmlSerializer ser = new XmlSerializer(typeof(PFFilter));
        ...
        /// <returns>An instance of PFFilter.</returns>
        public static PFFilter LoadFromXmlFile(string filePath)
        {
            XmlSerializer deserializer = new XmlSerializer(typeof(PFFilter));
            TextReader textReader = new StreamReader(filePath);
            PFFilter columnDefinitions;
            columnDefinitions = (PFFilter)deserializer.Deserialize(textReader);
            textReader.Close();
