...
{
    /// <summary>
    /// Contains routines for producing a pdf file from an XML or DataTable object.
    /// </summary>
    public class PDFFileOutputProcessor
    {
        ...
        private enOutputType _outputType = enOutputType.PDFFile;
        ...
        public PDFFileOutputProcessor(string outputFilename)
        {
        ...
        public PDFFileOutputProcessor(string outputFilename, bool replaceExistingFile)
        {
            _outputFileName = outputFilename;
        ...
        {
            XmlSerializer ser = new XmlSerializer(typeof(PDFFileOutputProcessor));
        ...
        /// <returns>An instance of PDFFileOutputProcessor.</returns>
        public static PDFFileOutputProcessor LoadFromXmlFile(string filePath)
        {
            XmlSerializer deserializer = new XmlSerializer(typeof(PDFFileOutputProcessor));
            TextReader textReader = new StreamReader(filePath);
            PDFFileOutputProcessor columnDefinitions;
            columnDefinitions = (PDFFileOutputProcessor)deserializer.Deserialize(textReader);
            textReader.Close();
