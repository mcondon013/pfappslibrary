...
{
    /// <summary>
    /// Class for the management of output to a text file that contains delimited data lines.
    /// </summary>
    public class DelimitedTextFileOutputProcessor
    {
        ...
        private enOutputType _outputType = enOutputType.DelimitedTextFile;
        ...
        /// Constructor.
        /// </summary>
        public DelimitedTextFileOutputProcessor()
        {
            ;
        }
        ...
        public DelimitedTextFileOutputProcessor(string outputFileName)
        {
        ...
        public DelimitedTextFileOutputProcessor(string outputFileName, bool replaceExistingFile)
        {
            _outputFileName = outputFileName;
        ...
        /// <param name="outputFileName">Full path to the output file.</param>
        /// <param name="replaceExistingFile">True to overwrite existing file with same name. Otherwise, set to false to throw an error if file with same name already exists.</param>
        /// <param name="columnDelimiter">Character or characters to use to delimit column data in the output. Default is comma.</param>
        public DelimitedTextFileOutputProcessor(string outputFileName, bool replaceExistingFile, string columnDelimiter)
        {
            _outputFileName = outputFileName;
            _replaceExistingFile = replaceExistingFile;
        ...
        public DelimitedTextFileOutputProcessor(string outputFileName, bool replaceExistingFile, string columnDelimiter, bool columnNamesOnFirstLine)
        {
            _outputFileName = outputFileName;
            _replaceExistingFile = replaceExistingFile;
            _columnDelimiter = columnDelimiter;
        ...
        /// <param name="columnDelimiter">Character or characters to use to delimit column data in the output. Default is comma.</param>
        /// <param name="columnNamesOnFirstLine">Set to true if you want the column names to appear in the first line of the output.</param>
        /// <param name="lineTerminator">Character or characters to use to mark the end of a line of data. Default is .NET Environment.NewLine constant (usually carriage return/line feed).</param>
        public DelimitedTextFileOutputProcessor(string outputFileName, bool replaceExistingFile, string columnDelimiter, bool columnNamesOnFirstLine, string lineTerminator)
        {
            _outputFileName = outputFileName;
            _replaceExistingFile = replaceExistingFile;
            _columnDelimiter = columnDelimiter;
        ...
        public DelimitedTextFileOutputProcessor(string outputFileName, bool replaceExistingFile, string columnDelimiter, bool columnNamesOnFirstLine, string lineTerminator, bool stringValuesSurroundedWithQuotationMarks)
        {
            _outputFileName = outputFileName;
            _replaceExistingFile = replaceExistingFile;
            _columnDelimiter = columnDelimiter;
            _columnNamesOnFirstLine = columnNamesOnFirstLine;
            _lineTerminator = lineTerminator;
            _stringValuesSurroundedWithQuotationMarks = stringValuesSurroundedWithQuotationMarks;
        }

        //properties

        /// <summary>
        /// Always set to enOutputType.DelimitedTextFile constant.
        /// </summary>
        public enOutputType OutputType
        {
            ...
            set
            {
                _outputType = enOutputType.DelimitedTextFile;
            }
        }
        ...
        /// <summary>
        /// Character or characters to use to delimit column data in the output. Default is comma.
        /// </summary>
        ...
        /// <summary>
        /// Character or characters to use to mark the end of a line of data. Default is .NET Environment.NewLine constant (usually carriage return/line feed).
        /// </summary>
        ...
        public bool WriteDataToOutput(DataTable dt)
        {
            ...
            try
            {
                ...
                //_exporter.ExtractDelimitedDataFromTable(dt, _columnDelimiter, _lineTerminator, _columnNamesOnFirstLine);
        ...
        private void WriteDelimitedFileOutputLine(string outputLine, int tableNumber)
        {
        ...
        {
            XmlSerializer ser = new XmlSerializer(typeof(DelimitedTextFileOutputProcessor));
        ...
        /// <returns>An instance of TextFileOutputDef.</returns>
        public static DelimitedTextFileOutputProcessor LoadFromXmlFile(string filePath)
        {
            XmlSerializer deserializer = new XmlSerializer(typeof(DelimitedTextFileOutputProcessor));
            TextReader textReader = new StreamReader(filePath);
            DelimitedTextFileOutputProcessor objectInstance;
            objectInstance = (DelimitedTextFileOutputProcessor)deserializer.Deserialize(textReader);
            textReader.Close();
        ...
        /// <returns>An instance of TextFileOutputDef.</returns>
        public static DelimitedTextFileOutputProcessor LoadFromXmlString(string xmlString)
        {
            XmlSerializer deserializer = new XmlSerializer(typeof(DelimitedTextFileOutputProcessor));
            StringReader strReader = new StringReader(xmlString);
            DelimitedTextFileOutputProcessor objectInstance;
            objectInstance = (DelimitedTextFileOutputProcessor)deserializer.Deserialize(strReader);
            strReader.Close();
            return objectInstance;
        }
