...
{
    /// <summary>
    /// Defines the output format to use.
    /// </summary>
    public class DataOutputDef
    {
        ...
        private enOutputType _outputType = enOutputType.NotSpecified;
        //constructors

        /// <summary>
        /// Constructor.
        /// </summary>
        public DataOutputDef()
        {
            ;
        }
        ...
        /// <summary>
        /// Defines type of data output to produce.
        /// </summary>
        ...
        {
            XmlSerializer ser = new XmlSerializer(typeof(DataOutputDef));
        ...
        /// <returns>An instance of DataOutputDef.</returns>
        public static DataOutputDef LoadFromXmlFile(string filePath)
        {
            XmlSerializer deserializer = new XmlSerializer(typeof(DataOutputDef));
            TextReader textReader = new StreamReader(filePath);
            DataOutputDef objectInstance;
            objectInstance = (DataOutputDef)deserializer.Deserialize(textReader);
            textReader.Close();
        ...
        private bool UseFieldsToString(Type pType)
        {
            ...
            //avoid having this type calling its own FieldsToString and going into an infinite loop
        ...
        /// <returns>An instance of DataOutputDef.</returns>
        public static DataOutputDef LoadFromXmlString(string xmlString)
        {
            XmlSerializer deserializer = new XmlSerializer(typeof(DataOutputDef));
            StringReader strReader = new StringReader(xmlString);
            DataOutputDef objectInstance;
            objectInstance = (DataOutputDef)deserializer.Deserialize(strReader);
            strReader.Close();
            return objectInstance;
        }
