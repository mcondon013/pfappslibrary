...
{
    /// <summary>
    /// Contains routines for generating an RTF file from an XML or a DataTable object.
    /// </summary>
    public class RTFFileOutputProcessor
    {
        ...
        private enOutputType _outputType = enOutputType.RTFFile;
        ...
        public RTFFileOutputProcessor(string outputFilename)
        {
        ...
        public RTFFileOutputProcessor(string outputFilename, bool replaceExistingFile)
        {
            _outputFileName = outputFilename;
        ...
        public bool WriteDataToOutput(DataTable dt)
        {
            ...
            try
            {
                ...
                rtfDoc = new PFRTFDocument(this.OutputFileName, this.ReplaceExistingFile);
                rtfDoc.WriteDataToDocument(dt);
        ...
        {
            XmlSerializer ser = new XmlSerializer(typeof(RTFFileOutputProcessor));
        ...
        /// <returns>An instance of RTFFileOutputProcessor.</returns>
        public static RTFFileOutputProcessor LoadFromXmlFile(string filePath)
        {
            XmlSerializer deserializer = new XmlSerializer(typeof(RTFFileOutputProcessor));
            TextReader textReader = new StreamReader(filePath);
            RTFFileOutputProcessor columnDefinitions;
            columnDefinitions = (RTFFileOutputProcessor)deserializer.Deserialize(textReader);
            textReader.Close();
