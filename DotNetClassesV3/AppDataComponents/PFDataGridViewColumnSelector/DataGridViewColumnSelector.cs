...
//
// This code was downloaded from CodeProject and modified for use by ProFast Computing.
//
// Code Project Author/credits
//
//  *****************************************
...
namespace PFDataGridViewColumnSelector
{
    /// <summary>
    /// Adds column show/hide capability to a DataGridView. 
    /// When user right-clicks the cell origin, 
    /// a popup, containing a list of checkbox and column names is shown. 
    /// </summary>
    public class DataGridViewColumnSelector
    {
        ...
        /// Constructor.
        /// </summary>
        /// <remarks>The constructor creates an instance of CheckedListBox and ToolStripDropDown.
        /// The CheckedListBox is hosted by ToolStripControlHost, which in turn is added to ToolStripDropDown.</remarks>
        ...
        /// Constructor.
        /// </summary>
        /// <param name="dgv">DataGridView object to which the column hiding will be attached.</param>
