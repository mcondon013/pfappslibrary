...
using System.IO;
using AppGlobals;
using TestprogRandomDataProcessor;
    ...
    public partial class MainForm : Form
    {
        ...
        private void RunTests()
        {
            ...
            try
            {
                ...
                if (this.chkColSpecForm.Checked)
                {
                    nNumTestsSelected++;
                    _appProcessor.ColSpecForm();
                }

                if (this.chkRandomNumbersForm.Checked)
                {
                    nNumTestsSelected++;
                    _appProcessor.RandomNumbersForm();
                }

                if (this.chkRandomDateTimesForm.Checked)
                {
                    nNumTestsSelected++;
                    _appProcessor.RandomDateTimesForm();
                }

                if (this.chkRandomBooleansForm.Checked)
                {
                    nNumTestsSelected++;
                    _appProcessor.RandomBooleansForm();
                }

                if (this.chkRandomStringsForm.Checked)
                {
                    nNumTestsSelected++;
                    _appProcessor.RandomStringsForm();
                }

                if (this.chkRandomWordsForm.Checked)
                {
                    nNumTestsSelected++;
                    _appProcessor.RandomWordsForm();
                }

                if (this.chkRandomBytesForm.Checked)
                {
                    nNumTestsSelected++;
                    _appProcessor.RandomBytesForm();
                }

                if (this.chkRandomNamesAndLocationsForm.Checked)
                {
                    nNumTestsSelected++;
                    _appProcessor.RandomNamesAndLocationsForm();
                }

                if (this.chkRandomCustomValuesForm.Checked)
                {
                    nNumTestsSelected++;
                    _appProcessor.RandomCustomValuesForm();
                }

                if (this.chkRandomDataElementsForm.Checked)
                {
                    nNumTestsSelected++;
                    _appProcessor.RandomDataElementsForm();
                }

                if (this.chkRandomDataFormsManager.Checked)
                {
                    nNumTestsSelected++;
                    _appProcessor.RandomDataFormsManager();
                }
