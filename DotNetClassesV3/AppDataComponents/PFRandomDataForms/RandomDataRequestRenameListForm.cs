...
{
    /// <summary>
    /// Class to manage renameing of elements shown as a list.
    /// </summary>
    public partial class RandomDataRequestRenameListForm : Form
    {
        ...
        /// Constructor.
        /// </summary>
        public RandomDataRequestRenameListForm()
        {
            InitializeComponent();
        }
        ...
        {
            RandomDataRequestRenameForm frm = new RandomDataRequestRenameForm();
            frm.Caption = "Rename Numeric Random Data Request";
