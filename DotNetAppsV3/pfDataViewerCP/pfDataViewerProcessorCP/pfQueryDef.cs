...
namespace pfDataViewerCPProcessor
{
    ...
    public class pfQueryDef
    {
        ...
        DatabasePlatform _databaseType = DatabasePlatform.Unknown;
        ...
        //properties
        /// <summary>
        /// Name that identifies the query.
        /// </summary>
        ...
        /// <summary>
        /// Database type to use for the query.
        /// </summary>
        ...
        /// <summary>
        /// ConnectionString for database to use.
        /// </summary>
        ...
        /// <summary>
        /// List of columns in query with optional randomizer data mask (random data) definition for each column.
        /// </summary>
        ...
        {
            XmlSerializer ser = new XmlSerializer(typeof(pfQueryDef));
        ...
        /// <returns>An instance of pfQueryDef.</returns>
        public static pfQueryDef LoadFromXmlFile(string filePath)
        {
            XmlSerializer deserializer = new XmlSerializer(typeof(pfQueryDef));
            TextReader textReader = new StreamReader(filePath);
            pfQueryDef columnDefinitions;
            columnDefinitions = (pfQueryDef)deserializer.Deserialize(textReader);
            textReader.Close();
