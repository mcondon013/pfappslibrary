...
namespace pfDataExtractorCPObjects
{
    ...
    /// </summary>
    public class PFRelationalDatabaseSource
    {
        ...
        /// Default constructor.
        /// </summary>
        public PFRelationalDatabaseSource()
        {
            ;
        }
        ...
        {
            XmlSerializer ser = new XmlSerializer(typeof(PFRelationalDatabaseSource));
        ...
        /// <returns>An instance of PFExtractorRelationalDatabaseSource.</returns>
        public static PFRelationalDatabaseSource LoadFromXmlFile(string filePath)
        {
            XmlSerializer deserializer = new XmlSerializer(typeof(PFRelationalDatabaseSource));
            TextReader textReader = new StreamReader(filePath);
            PFRelationalDatabaseSource columnDefinitions;
            columnDefinitions = (PFRelationalDatabaseSource)deserializer.Deserialize(textReader);
            textReader.Close();
