...
namespace pfDataExtractorCPObjects
{
    ...
    /// </summary>
    public class PFFixedLengthTextFileSource
    {
        ...
        private bool _lineTerminatorAppendedToEachLine = false;
        ...
        /// Default constructor.
        /// </summary>
        public PFFixedLengthTextFileSource()
        {
            ;
        }
        ...
        /// <summary>
        /// LineTerminatorAppendedToEachLine Property.
        /// </summary>
        public bool LineTerminatorAppendedToEachLine
        {
            get
            {
                return _lineTerminatorAppendedToEachLine;
            }
            set
            {
                _lineTerminatorAppendedToEachLine = value;
            }
        }
        ...
        {
            XmlSerializer ser = new XmlSerializer(typeof(PFFixedLengthTextFileSource));
        ...
        /// <returns>An instance of PFFixedLengthTextFileSource.</returns>
        public static PFFixedLengthTextFileSource LoadFromXmlFile(string filePath)
        {
            XmlSerializer deserializer = new XmlSerializer(typeof(PFFixedLengthTextFileSource));
            TextReader textReader = new StreamReader(filePath);
            PFFixedLengthTextFileSource columnDefinitions;
            columnDefinitions = (PFFixedLengthTextFileSource)deserializer.Deserialize(textReader);
            textReader.Close();
