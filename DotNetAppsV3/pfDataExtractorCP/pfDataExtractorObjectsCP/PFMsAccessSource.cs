...
namespace pfDataExtractorCPObjects
{
    ...
    public class PFMsAccessSource
    {
        ...
        private bool _sourceIsAccess2007 = false;
        private bool _sourceIsAccess2003 = true;
        ...
        /// <summary>
        /// SourceIsAccess2007 Property.
        /// </summary>
        public bool SourceIsAccess2007
        {
            get
            {
                return _sourceIsAccess2007;
            }
            set
            {
                _sourceIsAccess2007 = value;
            }
        }

        /// <summary>
        /// SourceIsAccess2003 Property.
        /// </summary>
        public bool SourceIsAccess2003
        {
            get
            {
                return _sourceIsAccess2003;
            }
            set
            {
                _sourceIsAccess2003 = value;
            }
        }
        ...
        {
            XmlSerializer ser = new XmlSerializer(typeof(PFMsAccessSource));
        ...
        /// <returns>An instance of PFMSAccessSource.</returns>
        public static PFMsAccessSource LoadFromXmlFile(string filePath)
        {
            XmlSerializer deserializer = new XmlSerializer(typeof(PFMsAccessSource));
            TextReader textReader = new StreamReader(filePath);
            PFMsAccessSource columnDefinitions;
            columnDefinitions = (PFMsAccessSource)deserializer.Deserialize(textReader);
            textReader.Close();
