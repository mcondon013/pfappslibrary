...
{
    /// <summary>
    /// Class containing options that can be specified to customize extractor data output.
    /// </summary>
    public class PFExtractorOutputOptions
    {
        ...
        private bool _addRowNumberToOutput = false;
        private bool _randomizeOutput = false;
        private bool _filterOutput = false;
        private PFList<DataTableRandomizerColumnSpec> _randomizerColSpecs = new PFList<DataTableRandomizerColumnSpec>();
        private PFFilter _outputFilter = new PFFilter();
        ...
        /// Default constructor.
        /// </summary>
        public PFExtractorOutputOptions()
        {
            ;
        }
        ...
        /// <summary>
        /// AddRowNumberToOutput Property.
        /// </summary>
        public bool AddRowNumberToOutput
        {
            get
            {
                return _addRowNumberToOutput;
            }
            set
            {
                _addRowNumberToOutput = value;
            }
        }

        /// <summary>
        /// RandomizeOutput Property.
        /// </summary>
        public bool RandomizeOutput
        {
            get
            {
                return _randomizeOutput;
            }
            set
            {
                _randomizeOutput = value;
            }
        }

        /// <summary>
        /// FilterOutput Property.
        /// </summary>
        ...
        /// <summary>
        /// RandomizerColSpecs Property.
        /// </summary>
        public PFList<DataTableRandomizerColumnSpec> RandomizerColSpecs
        {
            get
            {
                return _randomizerColSpecs;
            }
            set
            {
                _randomizerColSpecs = value;
            }
        }
        ...
        {
            XmlSerializer ser = new XmlSerializer(typeof(PFExtractorOutputOptions));
        ...
        public static PFExtractorOutputOptions LoadFromXmlFile(string filePath)
        {
            XmlSerializer deserializer = new XmlSerializer(typeof(PFExtractorOutputOptions));
            TextReader textReader = new StreamReader(filePath);
            PFExtractorOutputOptions fieldDefinitions;
            fieldDefinitions = (PFExtractorOutputOptions)deserializer.Deserialize(textReader);
            textReader.Close();
        ...
        /// <returns>An instance of PFExtractorOutputOptions.</returns>
        public static PFExtractorOutputOptions LoadFromXmlString(string xmlString)
        {
            XmlSerializer deserializer = new XmlSerializer(typeof(PFExtractorOutputOptions));
            StringReader strReader = new StringReader(xmlString);
            PFExtractorOutputOptions fieldDefinitions;
            fieldDefinitions = (PFExtractorOutputOptions)deserializer.Deserialize(strReader);
            strReader.Close();
            return fieldDefinitions;
        }
        ...
        public PFExtractorOutputOptions Copy()
        {
            string xmlString = this.ToXmlString();
            PFExtractorOutputOptions newInstance = PFExtractorOutputOptions.LoadFromXmlString(xmlString);
            return newInstance;
        }
