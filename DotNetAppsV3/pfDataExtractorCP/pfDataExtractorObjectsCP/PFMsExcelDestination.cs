...
namespace pfDataExtractorCPObjects
{
    ...
    /// </summary>
    public class PFMsExcelDestination
    {
        ...
        private bool _destinationIsExcel2007Format = true;
        private bool _destinationIsExcel2003Format = false;
        private bool _destinationIsExcelCsvFormat = false;
        private string _documentFilePath = string.Empty;
        private string _sheetName = "Sheet1";
        private bool _overwriteFileIfExists = true;
        private bool _overwriteSheetIfExists = true;
        ...
        /// <summary>
        /// DestinationIsExcel2007Format Property.
        /// </summary>
        public bool DestinationIsExcel2007Format
        {
            get
            {
                return _destinationIsExcel2007Format;
            }
            set
            {
                _destinationIsExcel2007Format = value;
            }
        }

        /// <summary>
        /// DestinationIsExcel2003Format Property.
        /// </summary>
        public bool DestinationIsExcel2003Format
        {
            get
            {
                return _destinationIsExcel2003Format;
            }
            set
            {
                _destinationIsExcel2003Format = value;
            }
        }

        /// <summary>
        /// DestinationIsExcelCsvFormat Property.
        /// </summary>
        public bool DestinationIsExcelCsvFormat
        {
            get
            {
                return _destinationIsExcelCsvFormat;
            }
            set
            {
                _destinationIsExcelCsvFormat = value;
            }
        }
        ...
        /// <summary>
        /// OverwriteSheetIfExists Property.
        /// </summary>
        public bool OverwriteSheetIfExists
        {
            get
            {
                return _overwriteSheetIfExists;
            }
            set
            {
                _overwriteSheetIfExists = value;
            }
        }
        ...
        {
            XmlSerializer ser = new XmlSerializer(typeof(PFMsExcelDestination));
        ...
        /// <returns>An instance of PFMsExcelDestination.</returns>
        public static PFMsExcelDestination LoadFromXmlFile(string filePath)
        {
            XmlSerializer deserializer = new XmlSerializer(typeof(PFMsExcelDestination));
            TextReader textReader = new StreamReader(filePath);
            PFMsExcelDestination columnDefinitions;
            columnDefinitions = (PFMsExcelDestination)deserializer.Deserialize(textReader);
            textReader.Close();
