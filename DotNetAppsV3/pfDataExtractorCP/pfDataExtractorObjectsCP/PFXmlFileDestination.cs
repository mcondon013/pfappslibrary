...
namespace pfDataExtractorCPObjects
{
    ...
    /// </summary>
    public class PFXmlFileDestination
    {
        ...
        private string _destXmlFilePath = string.Empty;
        private bool _replaceExistingXmlFile = false;
        private bool _destXmlNoSchema = true;
        private bool _destXmlSchemaInXmlFile = false;
        private bool _destXmlSchemaInSeparateXsdFile = false;
        private string _destXsdFilePath = string.Empty;
        private bool _replaceExistingXsdFile = false;
        ...
        /// <summary>
        /// DestXmlFilePath Property.
        /// </summary>
        public string DestXmlFilePath
        {
            get
            {
                return _destXmlFilePath;
            }
            set
            {
                _destXmlFilePath = value;
            }
        }

        /// <summary>
        /// ReplaceExistingXmlFile Property.
        /// </summary>
        public bool ReplaceExistingXmlFile
        {
            get
            {
                return _replaceExistingXmlFile;
            }
            set
            {
                _replaceExistingXmlFile = value;
            }
        }

        /// <summary>
        /// DestXmlNoSchema Property.
        /// </summary>
        public bool DestXmlNoSchema
        {
            get
            {
                return _destXmlNoSchema;
            }
            set
            {
                _destXmlNoSchema = value;
            }
        }

        /// <summary>
        /// DestXmlSchemaInXmlFile Property.
        /// </summary>
        public bool DestXmlSchemaInXmlFile
        {
            get
            {
                return _destXmlSchemaInXmlFile;
            }
            set
            {
                _destXmlSchemaInXmlFile = value;
            }
        }

        /// <summary>
        /// DestXmlSchemaInSeparateXsdFile Property.
        /// </summary>
        public bool DestXmlSchemaInSeparateXsdFile
        {
            get
            {
                return _destXmlSchemaInSeparateXsdFile;
            }
            set
            {
                _destXmlSchemaInSeparateXsdFile = value;
            }
        }

        /// <summary>
        /// DestXsdFilePath Property.
        /// </summary>
        public string DestXsdFilePath
        {
            get
            {
                return _destXsdFilePath;
            }
            set
            {
                _destXsdFilePath = value;
            }
        }

        /// <summary>
        /// ReplaceExistingXsdFile Property.
        /// </summary>
        public bool ReplaceExistingXsdFile
        {
            get
            {
                return _replaceExistingXsdFile;
            }
            set
            {
                _replaceExistingXsdFile = value;
            }
        }
        ...
        {
            XmlSerializer ser = new XmlSerializer(typeof(PFXmlFileDestination));
        ...
        /// <returns>An instance of PFXmlFileDestination.</returns>
        public static PFXmlFileDestination LoadFromXmlFile(string filePath)
        {
            XmlSerializer deserializer = new XmlSerializer(typeof(PFXmlFileDestination));
            TextReader textReader = new StreamReader(filePath);
            PFXmlFileDestination columnDefinitions;
            columnDefinitions = (PFXmlFileDestination)deserializer.Deserialize(textReader);
            textReader.Close();
