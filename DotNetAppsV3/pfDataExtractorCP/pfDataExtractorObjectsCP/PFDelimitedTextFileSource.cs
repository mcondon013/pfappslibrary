...
namespace pfDataExtractorCPObjects
{
    ...
    /// </summary>
    public class PFDelimitedTextFileSource
    {
        ...
        /// Default constructor.
        /// </summary>
        public PFDelimitedTextFileSource()
        {
            ;
        }
        ...
        /// <summary>
        /// Retrieves the character(s) being used to delimit a column in a text file data source.
        /// </summary>
        ...
        {
            XmlSerializer ser = new XmlSerializer(typeof(PFDelimitedTextFileSource));
        ...
        /// <returns>An instance of PFDelimitedTextFileSource.</returns>
        public static PFDelimitedTextFileSource LoadFromXmlFile(string filePath)
        {
            XmlSerializer deserializer = new XmlSerializer(typeof(PFDelimitedTextFileSource));
            TextReader textReader = new StreamReader(filePath);
            PFDelimitedTextFileSource columnDefinitions;
            columnDefinitions = (PFDelimitedTextFileSource)deserializer.Deserialize(textReader);
            textReader.Close();
