...
namespace pfDataExtractorCPObjects
{
    ...
    public class PFXmlFileSource
    {
        ...
        private bool _sourceXmlNoSchema = true;
        private bool _sourceXmlSchemaInXmlFile = false;
        private bool _sourceXmlSchemaInSeparateXsdFile = false;
        private string _sourceXsdFilePath = string.Empty;
        ...
        /// <summary>
        /// SourceXmlNoSchema Property.
        /// </summary>
        public bool SourceXmlNoSchema
        {
            get
            {
                return _sourceXmlNoSchema;
            }
            set
            {
                _sourceXmlNoSchema = value;
            }
        }

        /// <summary>
        /// SourceXmlSchemaInXmlFile Property.
        /// </summary>
        public bool SourceXmlSchemaInXmlFile
        {
            get
            {
                return _sourceXmlSchemaInXmlFile;
            }
            set
            {
                _sourceXmlSchemaInXmlFile = value;
            }
        }

        /// <summary>
        /// SourceXmlSchemaInSeparateXsdFile Property.
        /// </summary>
        public bool SourceXmlSchemaInSeparateXsdFile
        {
            get
            {
                return _sourceXmlSchemaInSeparateXsdFile;
            }
            set
            {
                _sourceXmlSchemaInSeparateXsdFile = value;
            }
        }

        /// <summary>
        /// SourceXsdFilePath Property.
        /// </summary>
        public string SourceXsdFilePath
        {
            get
            {
                return _sourceXsdFilePath;
            }
            set
            {
                _sourceXsdFilePath = value;
            }
        }
        ...
        {
            XmlSerializer ser = new XmlSerializer(typeof(PFXmlFileSource));
        ...
        /// <returns>An instance of PFXmlFileSource.</returns>
        public static PFXmlFileSource LoadFromXmlFile(string filePath)
        {
            XmlSerializer deserializer = new XmlSerializer(typeof(PFXmlFileSource));
            TextReader textReader = new StreamReader(filePath);
            PFXmlFileSource columnDefinitions;
            columnDefinitions = (PFXmlFileSource)deserializer.Deserialize(textReader);
            textReader.Close();
