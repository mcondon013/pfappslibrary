...
namespace pfDataExtractorCPObjects
{
    ...
    /// </summary>
    public class PFRelationalDatabaseDestination
    {
        ...
        private int _outputBatchSize = 200;
        ...
        /// Default constructor.
        /// </summary>
        public PFRelationalDatabaseDestination()
        {
            ;
        }
        ...
        {
            XmlSerializer ser = new XmlSerializer(typeof(PFRelationalDatabaseDestination));
        ...
        /// <returns>An instance of PFRelationalDatabaseDestination.</returns>
        public static PFRelationalDatabaseDestination LoadFromXmlFile(string filePath)
        {
            XmlSerializer deserializer = new XmlSerializer(typeof(PFRelationalDatabaseDestination));
            TextReader textReader = new StreamReader(filePath);
            PFRelationalDatabaseDestination columnDefinitions;
            columnDefinitions = (PFRelationalDatabaseDestination)deserializer.Deserialize(textReader);
            textReader.Close();
