...
namespace pfDataExtractorCPObjects
{
    ...
    /// </summary>
    public class PFMsAccessDestination
    {
        ...
        private bool _destinationIsAccess2007 = false;
        private bool _destinationIsAccess2003 = true;
        private string _databasePath = string.Empty;
        private bool _overwriteDatabaseFileIfExists = true;
        private string _databaseUsername = "admin";
        private string _databasePassword = string.Empty;
        private string _outputTableName = string.Empty;
        private bool _overwriteTableIfExists = true;
        ...
        /// <summary>
        /// DestinationIsAccess2007 Property.
        /// </summary>
        public bool DestinationIsAccess2007
        {
            get
            {
                return _destinationIsAccess2007;
            }
            set
            {
                _destinationIsAccess2007 = value;
            }
        }

        /// <summary>
        /// DestinationIsAccess2003 Property.
        /// </summary>
        public bool DestinationIsAccess2003
        {
            get
            {
                return _destinationIsAccess2003;
            }
            set
            {
                _destinationIsAccess2003 = value;
            }
        }
        ...
        /// </summary>
        public bool OverwriteDatabaseFileIfExists
        {
            get
            {
                return _overwriteDatabaseFileIfExists;
            }
            set
            {
                _overwriteDatabaseFileIfExists = value;
            }
        }
        ...
        /// <summary>
        /// OutputTableName Property.
        /// </summary>
        public string OutputTableName
        {
            get
            {
                return _outputTableName;
            }
            set
            {
                _outputTableName = value;
            }
        }

        /// <summary>
        /// OverwriteTableIfExists Property.
        /// </summary>
        public bool OverwriteTableIfExists
        {
            get
            {
                return _overwriteTableIfExists;
            }
            set
            {
                _overwriteTableIfExists = value;
            }
        }
        ...
        {
            XmlSerializer ser = new XmlSerializer(typeof(PFMsAccessDestination));
        ...
        /// <returns>An instance of PFMsAccessDestination.</returns>
        public static PFMsAccessDestination LoadFromXmlFile(string filePath)
        {
            XmlSerializer deserializer = new XmlSerializer(typeof(PFMsAccessDestination));
            TextReader textReader = new StreamReader(filePath);
            PFMsAccessDestination columnDefinitions;
            columnDefinitions = (PFMsAccessDestination)deserializer.Deserialize(textReader);
            textReader.Close();
