...
rem "c:\Program Files (x86)\Microsoft Visual Studio 10.0\VC\\bin\EditBin.exe" "C:\ProFast\CPApps\DotNetAppsV3\pfDataExtractorCP\pfDataExtractorCP\bin\Release\pfDataExtractorCP.exe"  /LARGEADDRESSAWARE
