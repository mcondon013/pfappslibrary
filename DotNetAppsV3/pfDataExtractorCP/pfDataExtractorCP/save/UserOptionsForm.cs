...
#pragma warning disable 1591
    ...
    public partial class UserOptionsForm : Form
    {
        ...
        private class PFUserOptions
        {
            ...
            private bool _eraseOutputLogBeforeEachRun = false;
            ...
            /// <summary>
            /// EraseOutputLogBeforeEachRun Property.
            /// </summary>
            public bool EraseOutputLogBeforeEachRun
            {
                get
                {
                    return _eraseOutputLogBeforeEachRun;
                }
                set
                {
                    _eraseOutputLogBeforeEachRun = value;
                }
            }
        ...
        {
            _userOptions.UserOption1 = this.txtUserOption1.Text;
            _userOptions.UserOption2 = this.txtUserOption2.Text;
            ...
            _userOptions.EraseOutputLogBeforeEachRun = this.chkEraseOutputLogBeforeEachTest.Checked;
            _userOptions.UserOption4 = this.cboUserOption4.Text;
        }
        ...
        private void LoadUserConfigItems()
        {
            ...
            _userOptions.ShowOutputLog = Properties.Settings.Default.ShowOutputLog;
            _userOptions.EraseOutputLogBeforeEachRun = Properties.Settings.Default.EraseOutputLogBeforeEachRun;
            ...
            this.chkEraseOutputLogBeforeEachTest.Checked = _userOptions.EraseOutputLogBeforeEachRun;
        ...
        private void LoadDefaultUserConfigItems()
        {
            ...
            _userOptions.ShowOutputLog = Convert.ToBoolean(Properties.Settings.Default.Properties["ShowOutputLog"].DefaultValue);
            _userOptions.EraseOutputLogBeforeEachRun = Convert.ToBoolean(Properties.Settings.Default.Properties["EraseOutputLogBeforeEachRun"].DefaultValue);
        ...
        private bool UpdateUserConfigItems(bool forceUpdate)
        {
            ...
            {
                numUpdates++;
                Properties.Settings.Default["ShowOutputLog"] = this.chkShowOutputLog.Checked;
            }

            if (this.chkEraseOutputLogBeforeEachTest.Checked != _userOptions.EraseOutputLogBeforeEachRun
                || forceUpdate == true)
            {
                numUpdates++;
                Properties.Settings.Default["EraseOutputLogBeforeEachRun"] = this.chkEraseOutputLogBeforeEachTest.Checked;
            }
