...
namespace InitWinFormsAppWithToolbarExt
{
    public partial class MainForm : Form
    {
        ...
        private string _mRUListSaveFileSubFolder = @"PFApps\InitWinFormsAppWithToolbarExt\Mru\";
        private string _mRUListSaveRegistryKey = @"SOFTWARE\PFApps\InitWinFormsAppWithToolbarExt";
        ...
        internal void InitMruList()
        {
            ...
            _mRUListSaveFileSubFolder = AppConfig.GetStringValueFromConfigFile("MRUListSaveFileSubFolder", @"PFApps\InitWinFormsAppWithToolbarExt\Mru\");
            _mRUListSaveRegistryKey = AppConfig.GetStringValueFromConfigFile("MRUListSaveRegistryKey", @"SOFTWARE\PFApps\InitWinFormsAppWithToolbarExt");
        ...
        internal void SetHelpFileValues()
        {
            ...
            string helpFileName = AppConfig.GetStringValueFromConfigFile("HelpFileName", "InitWinFormsAppWithToolbarExt.chm");
        ...
        private void RunTests()
        {
            ...
            try
            {
                ...
                {
                    numTestsSelected++;
                    _appProcessor.RunShowDateTimeTest(this.chkShowDateTimeTest.Text);
                }
