    ...
    public partial class MainForm : Form
    {
        ...
        private void RunTests()
        {
            ...
            try
            {
                ...
                if (this.chkSimulateError.Checked)
                {
                    nNumTestsSelected++;
                    Tests.SimulateError(this);
                }
        ...
        private void cmdLoadTextToParse_Click(object sender, EventArgs e)
        {
            string textValue = string.Empty;
            //textValue = "aaaaaaaaaaabbbbbbbbbbbbccccccccccccccaaaaaaaaaaabbbbbbbbbbbbccccccccccccccdddddddddddddddddddddeeeeeeeeeeeeeee";
            textValue = "firstname   lastname   yesno yesyesaaaaaaaaaaabbbbbbbbbbbbccccccccccccccaaaaaaaaaaabbbbbbbbbbbbccccccccccccccdddddddddddddddddddddeeeeeeeeeeeeeeexxxxxyyyyyzzzzz123456789";
            //textValue += Environment.NewLine;
            //textValue += "aaaaaaaaaaabbbbbbbbbbbbccccccccccccccdddddddddddddddddddddeeeeeeeeeeeeeee";
            rulerControl1.RulerText = textValue + " ";
            textValue = "second line of text is shown here saaaaaaaaaaabbbbbbbbbbbbccccccccccccccaaaaaaaaaaabbbbbbbbbbbbccccccccccccccdddddddddddddddddddddeeeeeeeeeeeeeeexxxxxyyyyyzzzzz123456789";
            rulerControl1.RulerTextLinesExtra = textValue;
            textValue = "third  line of text is shown here saaaaaaaaaaabbbbbbbbbbbbccccccccccccccaaaaaaaaaaabbbbbbbbbbbbccccccccccccccdddddddddddddddddddddeeeeeeeeeeeeeeexxxxxyyyyyzzzzz123456789";
            rulerControl1.RulerTextLinesExtra = textValue;
            textValue = "fourth line of text is shown here saaaaaaaaaaabbbbbbbbbbbbccccccccccccccaaaaaaaaaaabbbbbbbbbbbbccccccccccccccdddddddddddddddddddddeeeeeeeeeeeeeeexxxxxyyyyyzzzzz123456789";
            rulerControl1.RulerTextLinesExtra = textValue;
        }

        private void cmdGetParse_Click(object sender, EventArgs e)
        {
            string fieldOffsets = string.Empty;

            if (rulerControl1.FieldOffSets.Count == 0)
            {
                _msg.Length = 0;
                _msg.Append("No field offsets found ...");
                AppMessages.DisplayAlertMessage(_msg.ToString());
                return;
            }

            for (int i = 0; i < rulerControl1.FieldOffSets.Count; i++)
            {
                if (i > 0)
                {
                    fieldOffsets += " ," + rulerControl1.FieldOffSets[i].ToString();
                }
                else
                {
                    fieldOffsets += rulerControl1.FieldOffSets[i].ToString();
